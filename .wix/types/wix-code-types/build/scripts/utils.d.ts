...
import { AutocompleteType, WixModulesMap, WixPackage } from "@wix/wix-code-common";
import { TargetContexts } from "./types";
export declare const writeModulesMapToJSON: (wixModules: WixModulesMap, moduleListFilePath: string) => void;
